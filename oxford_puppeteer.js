...
class OxfordScraper {
        ...
        try {
            return await this.page.evaluate(() => {
                ...
                return ['captcha','verify you are human','access denied','robot',
                        ...
                        'challenge','just a moment'].some(p => txt.includes(p));
            });
        ...
        for (let attempt = 1; attempt <= 3; attempt++) {
            try {
                ...
                if (await this._isCaptcha()) {
                    await this.rotateAndRestart(homeUrl || 'https://academic.oup.com');
                    await this.page.goto(url, { waitUntil: 'networkidle2', timeout: 60000 });
                }
                return;
            } catch (e) {
    ...
    async run() {
        ...
        if (await this._isCaptcha()) await this.rotateAndRestart('https://academic.oup.com');
