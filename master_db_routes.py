                    ...
                    for email, r in rows_dict.items():
                        if email in existing_set:
                            ...
                            to_insert.append({
                                'id':              str(uuid.uuid4()),
                                'email':           email[:500],
                                'author_name':     r['author_name'][:500],
                                'affiliation':     r['affiliation'][:500],
                                'article_url':     r['article_url'][:500],
                                'article_title':   r['article_title'][:500],
                                'conference_name': conf_name[:500],
                                'conference_code': r['conference_code'][:50],
                                'journal_name':    journal_name[:500],
                                'keyword':         keyword_val[:500],
